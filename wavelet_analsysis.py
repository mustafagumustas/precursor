...
period = period[:13]
# print("scale", len(scale), end="\n\n")
# print("singif", len(signif), end="\n\n")
# print("power", len(power), end="\n\n")
# print("global", len(global_ws), end="\n\n")
# print("period", len(period), end="\n\n")
...
plt.contour(time, period, sig95, [1], colors="k")
